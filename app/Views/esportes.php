...
<body>
    ...
    align-items: center;
    padding: 20px;
    padding-top: 15%; /* Ajuste o valor conforme necessário */
}
...
<div class="menu" id="menu">
    ...
    <main>
        <div class="event-card">
            <h2>Futsal sábado de tarde</h2>
            <img class="img1" src="https://media-public.canva.com/dcqmc/MAFQc6dcqmc/1/s.jpg"
                alt="Imagem do evento de futsal">
        ...
        <form class="subscription-form">
            ...
            <div class="form-group">
                <label>Turma:</label>
                <input type="text" placeholder="Digite sua turma">
            </div>
            <div class="form-group">
